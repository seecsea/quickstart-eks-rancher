...
[cols=2*]
|===
^|http://qs_launch_link[Deploy {partner-product-short-name} into a new VPC and new Amazon EKS cluster^]
...
^|http://qs_launch_link[Deploy {partner-product-short-name} into an existing VPC and a new Amazon EKS cluster^]
^|https://github.com/aws-quickstart/quickstart-eks-rancher/blob/main/templates/rancher.template.yaml[View template^]

^|http://qs_launch_link[Deploy {partner-product-short-name} into an existing VPC and existing Amazon EKS cluster^]
